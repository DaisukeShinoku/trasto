...
5.times do |n|
  ...
  「写真つきのツイート」「写真つきのツイート」「写真つきのツイート」",
  tweet_picture: open("#{Rails.root}/db/fixtures/free#{rand(1..11)}.jpg")
  )
end
...
Story.create!(
  ...
  story_image: open("#{Rails.root}/db/fixtures/non_musubiya1.jpg")
)
...
Story.create!(
  ...
  story_image: open("#{Rails.root}/db/fixtures/free1.jpg")
)
...
Story.create!(
  ...
  story_image: open("#{Rails.root}/db/fixtures/free2.jpg")
)
...
Story.create!(
  ...
  story_image: open("#{Rails.root}/db/fixtures/free3.jpg")
)
...
Story.create!(
  ...
  story_image: open("#{Rails.root}/db/fixtures/free4.jpg")
)
